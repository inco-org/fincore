...
class _RicherIpcaBackend(fincore.InMemoryBackend):
    ...
    _registry_ipca = [
        ...
        (datetime.date(2024, 11, 1), decimal.Decimal('0.62'))
    ]
...
def test_will_create_loan_daily_returns_jm_1():
    ...
    tst[39] = 2, 1, datetime.date(2024, 12, 7), '1.00027670', '1.00019940', '2193.43', '3044.29', '11005237.72'
    tst[40] = 2, 2, datetime.date(2024, 12, 8), '1.00027670', '1.00019940', '2193.86', '3046.34', '11010477.92'
    tst[41] = 2, 3, datetime.date(2024, 12, 9), '1.00027670', '1.00019940', '2194.30', '3048.40', '11015720.63'
    tst[42] = 2, 4, datetime.date(2024, 12, 10), '1.00027670', '1.00019940', '2194.74', '3050.46', '11020965.83'
    tst[43] = 2, 5, datetime.date(2024, 12, 11), '1.00027670', '1.00019940', '2195.18', '3052.52', '11026213.53'
    tst[44] = 2, 6, datetime.date(2024, 12, 12), '1.00027670', '1.00019940', '2195.61', '3054.58', '11031463.72'
    tst[45] = 2, 7, datetime.date(2024, 12, 13), '1.00027670', '1.00019940', '2196.05', '3056.64', '11036716.42'
    tst[46] = 2, 8, datetime.date(2024, 12, 14), '1.00027670', '1.00019940', '2196.49', '3058.71', '11041971.62'
    tst[47] = 2, 9, datetime.date(2024, 12, 15), '1.00027670', '1.00019940', '2196.93', '3060.77', '11047229.32'
    tst[48] = 2, 10, datetime.date(2024, 12, 16), '1.00027670', '1.00019940', '2197.37', '3062.84', '11052489.52'
    tst[49] = 2, 11, datetime.date(2024, 12, 17), '1.00027670', '1.00019940', '2197.80', '3064.90', '11057752.23'
    tst[50] = 2, 12, datetime.date(2024, 12, 18), '1.00027670', '1.00019940', '2198.24', '3066.97', '11063017.44'
    tst[51] = 2, 13, datetime.date(2024, 12, 19), '1.00027670', '1.00019940', '2198.68', '3069.04', '11068285.17'
    tst[52] = 2, 14, datetime.date(2024, 12, 20), '1.00027670', '1.00019940', '2199.12', '3071.11', '11073555.39'
    tst[53] = 2, 15, datetime.date(2024, 12, 21), '1.00027670', '1.00019940', '2199.56', '3073.18', '11078828.13'
    tst[54] = 2, 16, datetime.date(2024, 12, 22), '1.00027670', '1.00019940', '2200.00', '3075.25', '11084103.38'
    tst[55] = 2, 17, datetime.date(2024, 12, 23), '1.00027670', '1.00019940', '2200.44', '3077.33', '11089381.14'
    tst[56] = 2, 18, datetime.date(2024, 12, 24), '1.00027670', '1.00019940', '2200.87', '3079.40', '11094661.42'
    tst[57] = 2, 19, datetime.date(2024, 12, 25), '1.00027670', '1.00019940', '2201.31', '3081.48', '11099944.21'
    tst[58] = 2, 20, datetime.date(2024, 12, 26), '1.00027670', '1.00019940', '2201.75', '3083.55', '11105229.51'
    tst[59] = 2, 21, datetime.date(2024, 12, 27), '1.00027670', '1.00019940', '2202.19', '3085.63', '11110517.33'
    tst[60] = 2, 22, datetime.date(2024, 12, 28), '1.00027670', '1.00019940', '2202.63', '3087.71', '11115807.67'
    tst[61] = 2, 23, datetime.date(2024, 12, 29), '1.00027670', '1.00019940', '2203.07', '3089.79', '11121100.53'
    tst[62] = 2, 24, datetime.date(2024, 12, 30), '1.00027670', '1.00019940', '2203.51', '3091.87', '11126395.91'
    tst[63] = 2, 25, datetime.date(2024, 12, 31), '1.00027670', '1.00019940', '2203.95', '3093.95', '11131693.81'
    tst[64] = 2, 26, datetime.date(2025, 1, 1), '1.00027670', '1.00019940', '2204.39', '3096.03', '11136994.23'
    tst[65] = 2, 27, datetime.date(2025, 1, 2), '1.00027670', '1.00019940', '2204.83', '3098.12', '11142297.17'
    tst[66] = 2, 28, datetime.date(2025, 1, 3), '1.00027670', '1.00019940', '2205.27', '3100.20', '11147602.64'
    tst[67] = 2, 29, datetime.date(2025, 1, 4), '1.00027670', '1.00019940', '2205.71', '3102.29', '11152910.64'
    tst[68] = 2, 30, datetime.date(2025, 1, 5), '1.00027670', '1.00019940', '2206.15', '3104.38', '11158221.17'
    tst[69] = 2, 31, datetime.date(2025, 1, 6), '1.00027670', '1.00019940', '2206.59', '3106.47', '11163534.22'
