...
def get_delinquency_charges(
    ...
    extra_gain_arrear_date: datetime.date,  # Extra gain arrear, or delinquency, date.
    ...
    Calculates extra charges for a delinquent loan.
      ...
      • "extra_gain_arrear_date" (datetime.date): the delinquency date, used to calculate the daily interest rate.
    ...
    with a delayed payment from January 1, 2023 to January 1, 2023:
        ...
        > get_delinquency_charges(  # doctest: +SKIP
            ...
            extra_gain_arrear_date=datetime.date(2023, 1, 1),
    ...
    if not loan_vir:
        ...
        fv1 = loan_vir.backend.calculate_cdi_factor(extra_gain_arrear_date, extra_gain_arrear_date + datetime.timedelta(1), loan_vir.percentage)
